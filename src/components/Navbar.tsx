...
export default function Navbar() {
  ...
  return (
    <>
      {/* Hamburger Button */}
      <button
        className="fixed top-4 right-4 z-50 sm:hidden p-2 bg-gray-900 rounded-full shadow-xl transition-transform hover:scale-110 focus:outline-none"
      ...
      <div
        ...
        } bg-gray-900 p-2 rounded-xl shadow-lg`}
      >
        {navItems.map((item) => {
