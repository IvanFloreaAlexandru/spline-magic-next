...
// Simulăm EmailJS pentru demo (în proiectul real vei avea aceste librării)
const emailjs = {
  send: async (serviceId: string, templateId: string, params: any, publicKey: string) => {
    // Simulăm delay pentru trimiterea email-ului
    await new Promise(resolve => setTimeout(resolve, 2000));
    console.log("Email trimis cu succes:", params);
